...
///////////////////////////// Angle test/////////////////////////////////
float KalmanFilter::Angletest(int16_t ax,int16_t ay,int16_t az,int16_t gx,int16_t gy,int16_t gz,float dt,float Q_angle,float Q_gyro,
									float R_angle,float C_0,float K1)
{
  // int flag;
  //ƽ�����
  float Angle_preKalman = atan2(ay , az) * 57.3;           //�Ƕȼ��㹫ʽ,Angle:һ�׻����˲��������С��������б�Ƕ�
  Gyro_x = (gx - 128.1) / 131;              //�Ƕ�ת��
  
  // Serial.print("Angle pre Kalman in kalman: ");
  // Serial.println(Angle_preKalman);

  Kalman_Filter(Angle_preKalman, Gyro_x, dt, Q_angle, Q_gyro,R_angle,C_0);            //�����˲�
  //��ת�Ƕ�Z�����
